  ...
  template: `
    <div class="space-y-6">
      ...
      <div>
        ...
        <p class="text-neutral-500">Vue d'ensemble de l'activité du portail</p>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div class="stat-card">
            ...
            <div class="flex-1">
              ...
              <p class="text-xs text-primary-600">{{ stats()!.publishedArticles }} publiés</p>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="flex items-center gap-4">
              ...
              <div class="flex-1">
                ...
                <p class="text-neutral-500">Utilisateurs enregistrés</p>
